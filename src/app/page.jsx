...
export default function Home() {
  ...
  return (
    ...
    <div className="gradient-bg flex h-screen">
        ...
        <div className="flex flex-col justify-between items-start w-2/3 mt-16">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xs leading-normal font-light text-slate-500">
              I build pixed-perfect, engaging, and accessible digital
              experiences.
            </p>
          </div>
          {/* side-nav-menu */}
      ...
      >
        {/* About-section */}
        <section ref={aboutRef} className="scroll-mt-24 text-md ">
        ...
        {/* Project-section */}
        <section ref={projectsRef} className="scroll-mt-24 mt-32">
          <ProjectCard
            project_link={pl1}
            project_image={pi1}
            project_name={pn1}
