  ...
  return (
    <div className="group flex items-start justify-start rounded-sm px-6 py-4 mb-6 transition duration-200 hover:bg-slate-500 hover:bg-opacity-10 hover:backdrop-blur-md hover:backdrop-filter">
      ...
      <div className="pl-400 h-max w-full">
        ...
        <h3 id="experience_role_company" className="font-medium leading-snug text-white transition duration-200 group-hover:text-pink-500">
          {experience_role_company}
        </h3>
        {/* Experience Description */}
        <p id="experience_description" className="mt-2 text-sm leading-normal text-gray-400">
          {experience_description}
        </p>
